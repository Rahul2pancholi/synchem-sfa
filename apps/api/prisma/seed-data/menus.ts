...
export const SEED_MENUS: SeedMenuDefinition[] = [
  ...
  { menuCode: 'MAS10', menuName: 'Doctor Creation Request', menuType: 'T', menuUrl: '#/app/doctor-creation-request', parentCode: 'MAS', sortOrder: 261 },
  ...
  { menuCode: 'MAS11', menuName: 'Doctor Approval', menuType: 'T', menuUrl: '#/app/doctor-approval', parentCode: 'APP', sortOrder: 38 },
