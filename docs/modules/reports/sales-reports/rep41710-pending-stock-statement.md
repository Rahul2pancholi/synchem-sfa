# Pending Stock Statement

> **Menu Code:** `REP41710`  
> **Route:** `/app/report/pendingStockStatement`  
> **Module:** Reports > Sales Reports > Pending Stock Statement

---

## In Short (Simple English)

Report: Pending Stock Statement.

## Real Example (Synchem Pharma)

30 retailers pending stock statement.
...
- Chemists who haven't submitted stock
...
```
/app/report/pendingStockStatement
```
...
- [ ] Build UI screen at route `/app/report/pendingStockStatement`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41710`)
