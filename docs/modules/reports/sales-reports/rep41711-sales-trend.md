...
> **Menu Code:** `REP41711`  
> **Route:** `/app/report/salesTrend`  
> **Module:** Reports > Sales Reports > Sales Trend
...
Sales growing 5% month on month.
...
- [ ] Build UI screen at route `/app/report/salesTrend`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41711`)
