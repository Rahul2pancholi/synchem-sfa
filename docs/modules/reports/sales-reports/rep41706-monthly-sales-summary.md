...
> **Menu Code:** `REP41706`  
> **Route:** `/app/report/monthlySalesSummary/0`  
> **Module:** Reports > Sales Reports > Monthly Sales Summary
...
June total secondary sales ₹1.2 Cr.
...
```
/app/report/monthlySalesSummary/0
```
...
- [ ] Build UI screen at route `/app/report/monthlySalesSummary/0`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41706`)
