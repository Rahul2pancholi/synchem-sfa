...
> **Menu Code:** `REP41713`  
> **Route:** `/app/report/salesAndStockStatement`  
> **Module:** Reports > Sales Reports > Sales & Stock Statement

---

## In Short (Simple English)

Report: Sales & Stock Statement.

## Real Example (Synchem Pharma)

Sell-out plus inventory in one report.
...
```
/app/report/salesAndStockStatement
```
...
- [ ] Build UI screen at route `/app/report/salesAndStockStatement`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41713`)
