# Product-State Sales Analysis

> **Menu Code:** `REP41709`  
> **Route:** `/app/report/productStateSalesAnalysis`  
> **Module:** Reports > Sales Reports > Product-State Sales Analysis

---

## In Short (Simple English)

Report: Product-State Sales Analysis.

## Real Example (Synchem Pharma)

MP state SYNPAR sales ₹80L.
...
```
/app/report/productStateSalesAnalysis
```
...
- [ ] Build UI screen at route `/app/report/productStateSalesAnalysis`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41709`)
