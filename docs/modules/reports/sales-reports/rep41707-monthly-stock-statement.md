...
> **Menu Code:** `REP41707`  
> **Route:** `/app/report/monthlyStockStatement/0`  
> **Module:** Reports > Sales Reports > Monthly Stock Statement

---

## In Short (Simple English)

Report: Monthly Stock Statement.

## Real Example (Synchem Pharma)

Market closing stock for all products.
...
```
/app/report/monthlyStockStatement/0
```
...
- [ ] Build UI screen at route `/app/report/monthlyStockStatement/0`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41707`)
