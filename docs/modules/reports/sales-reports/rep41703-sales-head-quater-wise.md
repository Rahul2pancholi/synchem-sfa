# Sales Head Quater Wise

> **Menu Code:** `REP41703`  
> **Route:** `/app/report/headQuarterWiseSalesSummary`  
> **Module:** Reports > Sales Reports > Sales Head Quater Wise

---

## In Short (Simple English)

Report: Sales Head Quater Wise.

## Real Example (Synchem Pharma)

Indore ₹30L, Dewas ₹12L.
...
```
/app/report/headQuarterWiseSalesSummary
```
...
- [ ] Build UI screen at route `/app/report/headQuarterWiseSalesSummary`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41703`)
