...
> **Menu Code:** `REP41714`  
> **Route:** `/app/report/salesTrendManager`  
> **Module:** Reports > Sales Reports > Manager Sales Trend

---

## In Short (Simple English)

Report: Manager Sales Trend.

## Real Example (Synchem Pharma)

Priya's team sales trend over 6 months.
...
- [ ] Build UI screen at route `/app/report/salesTrendManager`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41714`)
