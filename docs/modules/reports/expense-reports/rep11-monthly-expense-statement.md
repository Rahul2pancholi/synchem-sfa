...
> **Menu Code:** `REP11`  
> **Route:** `/app/report/monthlyExpenseStatement`  
> **Module:** Reports > Expense Reports > Monthly Expense Statement

---

## In Short (Simple English)

Report: Monthly Expense Statement.

## Real Example (Synchem Pharma)

Amit's full June expense breakdown.
...
```
/app/report/monthlyExpenseStatement
```
...
- [ ] Build UI screen at route `/app/report/monthlyExpenseStatement`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP11`)
