# Product Wise Target Vs Achievement

> **Menu Code:** `REP21`  
> **Route:** `/app/report/productTargetAchievement`  
> **Module:** Reports > Acheivement Reports > Product Wise Target Vs Achievement

---

## In Short (Simple English)

Report: Product Wise Target Vs Achievement.

## Real Example (Synchem Pharma)

SYNPAR target 1000, achieved 850.
...
```
/app/report/productTargetAchievement
```
...
- [ ] Build UI screen at route `/app/report/productTargetAchievement`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP21`)
