...
> **Menu Code:** `REP20`  
> **Route:** `/app/report/employeeTargetAchievement`  
> **Module:** Reports > Acheivement Reports > Monthly Target Achievement

---

## In Short (Simple English)

Report: Monthly Target Achievement.

## Real Example (Synchem Pharma)

Amit achieved 85% of June target.
...
```
/app/report/employeeTargetAchievement
```
...
- [x] Build UI screen at route `/app/report/employeeTargetAchievement`
- [ ] Create database tables for data listed above
- [x] Implement API endpoints
- [x] Add role permission check (menu code `REP20`)
