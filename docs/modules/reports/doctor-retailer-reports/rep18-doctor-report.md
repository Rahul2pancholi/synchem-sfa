...
> **Menu Code:** `REP18`  
> **Route:** `/app/report/doctors`  
> **Module:** Reports > Doctor/Retailer Reports > Doctor Report
...
List of 5000 doctors with last visit date.
...
- Doctor master listing with visit stats
...
- [x] Build UI screen at route `/app/report/doctors`
- [ ] Create database tables for data listed above
- [x] Implement API endpoints
- [x] Add role permission check (menu code `REP18`)
