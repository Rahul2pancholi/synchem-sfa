# Territory At Glance (New)

> **Menu Code:** `REP75`  
> **Route:** `/app/report/territoryAtGlance-new`  
> **Module:** Reports > Doctor/Retailer Reports > Territory At Glance (New)

---

## In Short (Simple English)

Report: Territory At Glance (New).

## Real Example (Synchem Pharma)

One-page Indore territory health view.
...
```
/app/report/territoryAtGlance-new
```
...
- [ ] Build UI screen at route `/app/report/territoryAtGlance-new`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP75`)
