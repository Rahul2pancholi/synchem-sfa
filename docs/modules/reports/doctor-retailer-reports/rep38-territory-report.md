...
> **Menu Code:** `REP38`  
> **Route:** `/app/report/territory`  
> **Module:** Reports > Doctor/Retailer Reports > Territory Report

---

## In Short (Simple English)

Report: Territory Report.

## Real Example (Synchem Pharma)

Indore HQ: ₹50L sales, 90% target.
...
- [ ] Build UI screen at route `/app/report/territory`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP38`)
