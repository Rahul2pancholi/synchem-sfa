...
> **Menu Code:** `REP62`  
> **Route:** `/app/report/callAverageTrend`  
> **Module:** Reports > Doctor/Retailer Reports > Call Average Trend

---

## In Short (Simple English)

Report: Call Average Trend.

## Real Example (Synchem Pharma)

Team average 7.2 calls/day in June vs 6.8 in May.
...
- [ ] Build UI screen at route `/app/report/callAverageTrend`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP62`)
