...
> **Menu Code:** `REP32`  
> **Route:** `/app/report/current-location`  
> **Module:** Reports > Tracking Reports > Current Location
...
See where Amit is right now on map.
...
- [ ] Build UI screen at route `/app/report/current-location`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP32`)
