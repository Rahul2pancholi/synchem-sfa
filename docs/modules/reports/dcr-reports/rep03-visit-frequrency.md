...
> **Menu Code:** `REP03`  
> **Route:** `/app/report/doctor-retailer/visitFrequency`  
> **Module:** Reports > DCR Reports > Visit Frequrency

---

## In Short (Simple English)

Report: Visit Frequrency.

## Real Example (Synchem Pharma)

Dr. Verma should get 2 visits/month but only got 1 — missed call.
...
- Planned vs actual frequency per doctor
...
```
/app/report/doctor-retailer/visitFrequency
```
...
- [ ] Build UI screen at route `/app/report/doctor-retailer/visitFrequency`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP03`)
