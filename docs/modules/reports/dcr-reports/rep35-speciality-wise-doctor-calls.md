# Speciality Wise Doctor Calls

> **Menu Code:** `REP35`  
> **Route:** `/app/report/specialityWiseDoctorCall`  
> **Module:** Reports > DCR Reports > Speciality Wise Doctor Calls

---

## In Short (Simple English)

Report: Speciality Wise Doctor Calls.

## Real Example (Synchem Pharma)

Cardiology: 200 calls, Pediatrics: 150 calls.
...
```
/app/report/specialityWiseDoctorCall
```
...
- [ ] Build UI screen at route `/app/report/specialityWiseDoctorCall`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP35`)
