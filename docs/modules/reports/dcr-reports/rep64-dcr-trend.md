...
> **Menu Code:** `REP64`  
> **Route:** `/app/report/dcrTrend`  
> **Module:** Reports > DCR Reports > DCR Trend
...
Calls dropped from 1200 in May to 1100 in June.
...
- [ ] Build UI screen at route `/app/report/dcrTrend`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP64`)
