# Manager Wise Focused Report

> **Menu Code:** `REP39`  
> **Route:** `/app/report/managerWiseFocusedList`  
> **Module:** Reports > DCR Reports > Manager Wise Focused Report

---

## In Short (Simple English)

Report: Manager Wise Focused Report.

## Real Example (Synchem Pharma)

Priya's team achieved 80% of SYNHEART focus target.
...
- Focused activity by manager team
...
```
/app/report/managerWiseFocusedList
```
...
- [ ] Build UI screen at route `/app/report/managerWiseFocusedList`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP39`)
