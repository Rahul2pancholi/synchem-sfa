# Monthly Covered Route

> **Menu Code:** `REP16`  
> **Route:** `/app/report/monthlyCoveredRoute`  
> **Module:** Reports > DCR Reports > Monthly Covered Route

---

## In Short (Simple English)

Report: Monthly Covered Route.

## Real Example (Synchem Pharma)

Route IND-R-05 covered 4 times in June.
...
```
/app/report/monthlyCoveredRoute
```
...
- [ ] Build UI screen at route `/app/report/monthlyCoveredRoute`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP16`)
