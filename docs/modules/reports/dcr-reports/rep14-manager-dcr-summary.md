...
> **Menu Code:** `REP14`  
> **Route:** `/app/report/managerDCRSummary`  
> **Module:** Reports > DCR Reports > Manager DCR Summary

---

## In Short (Simple English)

Report: Manager DCR Summary.

## Real Example (Synchem Pharma)

Manager Priya did 12 joint field days in June.
...
- [ ] Build UI screen at route `/app/report/managerDCRSummary`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP14`)
