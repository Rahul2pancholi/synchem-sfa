...
> **Menu Code:** `REP33`  
> **Route:** `/app/report/jointWorkReport`  
> **Module:** Reports > DCR Reports > Joint Work Report

---

## In Short (Simple English)

Report: Joint Work Report.

## Real Example (Synchem Pharma)

Priya joined Amit on 5 field days.
...
- [ ] Build UI screen at route `/app/report/jointWorkReport`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP33`)
