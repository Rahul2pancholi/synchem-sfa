...
> **Menu Code:** `REP29`  
> **Route:** `/app/report/doctor-dcr-detail`  
> **Module:** Reports > DCR Reports > Doctor DCR Detail

---

## In Short (Simple English)

Report: Doctor DCR Detail.

## Real Example (Synchem Pharma)

Dr. Verma visited 3 times by Amit, products detailed each time.
...
- [ ] Build UI screen at route `/app/report/doctor-dcr-detail`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP29`)
