...
> **Menu Code:** `REP01`  
> **Route:** `/app/report/dcr-summary`  
> **Module:** Reports > DCR Reports > DCR Summary
...
Shows how many calls each MR did in June — Amit 120 calls, Ravi 95 calls.
