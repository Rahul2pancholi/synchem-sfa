...
> **Menu Code:** `REP28`  
> **Route:** `/app/report/leave`  
> **Module:** Reports > Employee Reports > Leave Report
...
- [ ] Build UI screen at route `/app/report/leave`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP28`)
