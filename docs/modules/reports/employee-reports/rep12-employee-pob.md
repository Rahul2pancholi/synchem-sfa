...
> **Menu Code:** `REP12`  
> **Route:** `/app/report/employee-pob`  
> **Module:** Reports > Employee Reports > Employee POB
...
Amit ₹2.1L, Ravi ₹1.8L POB in June.
...
- [x] Build UI screen at route `/app/report/employee-pob`
- [ ] Create database tables for data listed above
- [x] Implement API endpoints
- [x] Add role permission check (menu code `REP12`)
