...
> **Menu Code:** `REP74`  
> **Route:** `/app/report/leaveAccrual`  
> **Module:** Reports > Employee Reports > Leave Accrual Report

---

## In Short (Simple English)

Report: Leave Accrual Report.

## Real Example (Synchem Pharma)

1.5 CL accrued for all MRs in June.
...
- [ ] Build UI screen at route `/app/report/leaveAccrual`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP74`)
