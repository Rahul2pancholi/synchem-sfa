...
> **Menu Code:** `REP41`  
> **Route:** `/app/report/attendanceReport`  
> **Module:** Reports > Employee Reports > Attendance Report
...
Amit: 22 field days, 2 leave, 1 holiday.
...
- [ ] Build UI screen at route `/app/report/attendanceReport`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP41`)
