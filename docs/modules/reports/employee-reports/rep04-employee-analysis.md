...
> **Menu Code:** `REP04`  
> **Route:** `/app/report/employee-analysis`  
> **Module:** Reports > Employee Reports > Employee Analysis
...
Amit: 95% call average, 80% POB target.
...
- [x] Build UI screen at route `/app/report/employee-analysis`
- [ ] Create database tables for data listed above
- [x] Implement API endpoints
- [x] Add role permission check (menu code `REP04`)
