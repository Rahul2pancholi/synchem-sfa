...
> **Menu Code:** `REP26`  
> **Route:** `/app/report/userYearlyActivity`  
> **Module:** Reports > Employee Reports > User Activity
...
Amit logged in 26 days, submitted 22 DCRs.
...
- [ ] Build UI screen at route `/app/report/userYearlyActivity`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP26`)
