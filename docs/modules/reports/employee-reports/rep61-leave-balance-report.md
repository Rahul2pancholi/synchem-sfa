...
> **Menu Code:** `REP61`  
> **Route:** `/app/report/leaveBalance`  
> **Module:** Reports > Employee Reports > Leave Balance Report
...
- [ ] Build UI screen at route `/app/report/leaveBalance`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP61`)
