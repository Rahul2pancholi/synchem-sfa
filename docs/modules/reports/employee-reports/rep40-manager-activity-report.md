...
> **Menu Code:** `REP40`  
> **Route:** `/app/report/managerActivityReport`  
> **Module:** Reports > Employee Reports > Manager Activity Report

---

## In Short (Simple English)

Report: Manager Activity Report.

## Real Example (Synchem Pharma)

Priya: 12 joint days, 8 meetings, 4 HO days.
...
```
/app/report/managerActivityReport
```
...
- [ ] Build UI screen at route `/app/report/managerActivityReport`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP40`)
