# Employee Wise Gift/Sample

> **Menu Code:** `REP25`  
> **Route:** `/app/report/employee/gift-sample`  
> **Module:** Reports > Gift/Sample Reports > Employee Wise Gift/Sample

---

## In Short (Simple English)

Report: Employee Wise Gift/Sample.

## Real Example (Synchem Pharma)

Amit gave 200 samples, Ravi 180.
...
```
/app/report/employee/gift-sample
```
...
- [ ] Build UI screen at route `/app/report/employee/gift-sample`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP25`)
