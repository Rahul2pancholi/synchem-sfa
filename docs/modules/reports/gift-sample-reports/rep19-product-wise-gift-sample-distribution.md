# Product Wise Gift/Sample Distribution

> **Menu Code:** `REP19`  
> **Route:** `/app/report/productWiseSampleDistribution`  
> **Module:** Reports > Gift/Sample Reports > Product Wise Gift/Sample Distribution

---

## In Short (Simple English)

Report: Product Wise Gift/Sample Distribution.

## Real Example (Synchem Pharma)

SYNPAR 40%, SYNCOLD 25% of samples.
...
```
/app/report/productWiseSampleDistribution
```
...
- [ ] Build UI screen at route `/app/report/productWiseSampleDistribution`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP19`)
