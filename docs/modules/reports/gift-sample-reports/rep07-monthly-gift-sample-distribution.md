# Monthly Gift/Sample Distribution

> **Menu Code:** `REP07`  
> **Route:** `/app/report/monthlySampleDistribution`  
> **Module:** Reports > Gift/Sample Reports > Monthly Gift/Sample Distribution

---

## In Short (Simple English)

Report: Monthly Gift/Sample Distribution.

## Real Example (Synchem Pharma)

5000 SYNPAR samples distributed in June.
...
```
/app/report/monthlySampleDistribution
```
...
- [ ] Build UI screen at route `/app/report/monthlySampleDistribution`
- [ ] Create database tables for data listed above
- [ ] Implement API endpoints
- [ ] Add role permission check (menu code `REP07`)
