...
export type MessageKey = Phase0MessageKey | Phase1MessageKey | Phase1ExtendedKey;

export const MESSAGES: Record<AppLanguage, Record<MessageKey, string>> = {
  en: { ...PHASE0_MESSAGES.en, ...PHASE1_MESSAGES.en, ...PHASE1_EXTENDED_MESSAGES.en },
  hi: { ...PHASE0_MESSAGES.hi, ...PHASE1_MESSAGES.hi, ...PHASE1_EXTENDED_MESSAGES.hi },
  hinglish: {
...
export { PHASE0_MESSAGE_KEYS, PHASE1_MESSAGE_KEYS, PHASE1_EXTENDED_KEYS };
